...
export PATH=$HOME/bin:/usr/local/opt/llvm/bin:/usr/local/bin:/usr/local/go/bin:$GOPATH/bin:$HOME/.npm-global/bin:$PATH
...
fpath+=$HOME/.zsh/pure
fpath+=('/home/cyprx/.npm-global/lib/node_modules/pure-prompt/functions')
ZSH_THEME=""
